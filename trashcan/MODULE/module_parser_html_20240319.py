...
class Tag:
    ...
    def text_all(self):return self.text+" ".join(self.children_str())
    def __repr__(self):
...
#------------------------------------------------------get_type: href
    ...
    def get_hrefs(self):
        ...
        return results
#------------------------------------------------------get_type: text
    def get_full_text(self,max_depth=3,depth=1):
    ...
    def get_text_all(self,max_depth=3,depth=1):
        ...
        for i in self.children_tag(): result=result+i.get_text_all(max_depth,depth+1)
